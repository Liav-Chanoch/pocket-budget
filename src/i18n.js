export const translations = {
  en: {
    ...
    // Offline
    offlineBanner: 'No internet — changes will sync when you reconnect',
    offlineNeedsInternet: 'Needs internet',
    offlineScanReceipt: 'Receipt scanning needs an internet connection.',
    offlineNearbyShops: 'Finding nearby shops needs an internet connection.',
    offlineEstimates: 'Offline — showing known prices only. AI estimates need internet.',
  ...
  he: {
    ...
    // Offline
    offlineBanner: 'אין אינטרנט — השינויים יסתנכרנו עם חזרת החיבור',
    offlineNeedsInternet: 'נדרש אינטרנט',
    offlineScanReceipt: 'סריקת קבלות דורשת חיבור לאינטרנט.',
    offlineNearbyShops: 'חיפוש חנויות בקרבת מקום דורש חיבור לאינטרנט.',
    offlineEstimates: 'לא מחובר — מוצגים רק מחירים ידועים. הערכות AI דורשות אינטרנט.',
